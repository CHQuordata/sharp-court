...
// Snapshot date — used to remind the user when classification was last
// reviewed. Update this when you audit the lists against real performance.
export const SHARP_BOOKS_REVIEWED = '2026-04-29';
